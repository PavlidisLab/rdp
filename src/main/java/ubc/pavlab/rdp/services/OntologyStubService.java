...
public class OntologyStubService {
    ...
    public void createStubs() {
        ...
        researchModelTerms.add( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId )
                ...
                .isGroup( true )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 2 ).name( "pdx-mouse" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 3 ).name( "pdx-fish" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 4 ).name( "pdx-other" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 5 ).name( "primary-organoid" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 6 ).name( "primary-co-culture" ).build() )
                .build() );
        ...
        researchModelTerms.add( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId )
                ...
                .isGroup( true )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 8 ).name( "transgenic-mouse" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 9 ).name( "transgenic-fish" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 10 ).name( "transgenic-other" ).build() )
                .build() );
        ...
        researchModelTerms.add( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId )
                ...
                .name( "gene-centric" )
                .isGroup( true )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 12 ).name( "mouse" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 13 ).name( "rat" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 14 ).name( "frog" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 15 ).name( "zebrafish" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 16 ).name( "fly" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 17 ).name( "worm" ).build() )
                .subTerm( OntologyTermInfo.builder( researchModelOntology, "RMODEL:" + ++termId ).active( true ).ordering( 18 ).name( "yeast" ).build() )
                .build() );
