...
public class UserManagerImpl implements UserManager {
    ...
    public void addGroupAuthority( String groupName, GrantedAuthority authority ) {
        ...
        GroupAuthority auth = new ubc.pavlab.rdp.server.model.common.auditAndSecurity.GroupAuthority();
    ...
    public void createGroup( String groupName, List<GrantedAuthority> authorities ) {
        ...
        UserGroup g = new ubc.pavlab.rdp.server.model.common.auditAndSecurity.UserGroup();
        g.setName( groupName );
        for ( GrantedAuthority ga : authorities ) {
            GroupAuthority groupAuthority = new ubc.pavlab.rdp.server.model.common.auditAndSecurity.GroupAuthority();
    ...
    public void createUser( UserDetails user ) {
        ...
        User u = new ubc.pavlab.rdp.server.model.common.auditAndSecurity.User();
